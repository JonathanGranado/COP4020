...
import static edu.ufl.cise.plc.ast.Types.Type.COLOR;
import static edu.ufl.cise.plc.ast.Types.Type.INT;
...
//                    sb.append(" = ");
        ...
        } // if left side is color and right side is int
        else if(varDeclaration.getNameDef().getType() == COLOR){
